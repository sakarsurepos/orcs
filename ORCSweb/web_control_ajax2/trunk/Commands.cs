...
namespace Robot
{
    class Commands
    {
        ...
        {
            TcpClnt.Send_Data_By_Client(movement.Motion_Forward_Backward(speed));
            time = times;
        ...
        {
            TcpClnt.Send_Data_By_Client(movement.Motion_Forward_Backward(63));
        ...
        public void Time_Thread_Fcn(object TcpClntobj)
        {
            ...
            tcp.Send_Data_By_Client(movement.Motion_Forward_Backward(63));
