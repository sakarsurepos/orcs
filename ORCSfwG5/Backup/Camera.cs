...
namespace Robot
{
	...
	public class Camera
	{
		...
		// alarm level
        private double alarmLevel = Robot1.sens * 0.005f;//Robot.sens*0.005f; //0.005

		//
		public event EventHandler	NewFrame;
		public event EventHandler	Alarm;
        public delegate void AlarmDelegate();  //kamil
        public static event AlarmDelegate AlarmDataReceived; //kamil
